package domain.repgen.smn_configuracion.smn_rel_linea_servicio;
...
public class XmlReport extends GenericOutput
{
	...
	public void print(TemplateEngine te, GenericTransaction data) throws Throwable
	{
		...
		String nameCustom  = "b_rel_lines_purchasing_services";
		String labelCustom = "${lbl:b_rel_lines_purchasing_services}";
