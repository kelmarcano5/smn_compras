package domain.repgen.smn_configuracion.smn_roles;
...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		d = rs.getString("smn_sucursales_id_name");
			if (d != null)
			{
			name  = "b_subsidiaries";
		...
		d = rs.getString("smn_sucursales_id");
			if (d != null)
			{
			name  = "b_subsidiaries";
			label = "${lbl:b_subsidiaries}";
		...
		d = rs.getString("smn_corporaciones_id_name");
			if (d != null)
			{
			name  = "b_corporation";
		...
		d = rs.getString("smn_corporaciones_id");
			if (d != null)
			{
			name  = "b_corporation";
			label = "${lbl:b_corporation}";
