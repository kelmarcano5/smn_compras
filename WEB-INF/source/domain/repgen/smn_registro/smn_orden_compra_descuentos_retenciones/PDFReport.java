package domain.repgen.smn_registro.smn_orden_compra_descuentos_retenciones;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("smn_codigo_descuento_rf_name");
			if (d != null)
			{
			name  = "b_smn_codigo_descuento_rf";
			label = "${lbl:b_smn_codigo_descuento_rf}";
		...
		d = rs.getString("smn_codigo_descuento_rf");
			if (d != null)
			{
			name  = "b_smn_codigo_descuento_rf";
			label = "${lbl:b_smn_codigo_descuento_rf}";
		...
		d = rs.getString("fecha_registro_fin");
			if (d != null)
			{
		...
		d = rs.getString("fecha_registro_ini");
			if (d != null)
			{
			name  = "b_store_date}@{\${def:date}";
			label = "${lbl:b_store_date}@{\${def:date}}";
