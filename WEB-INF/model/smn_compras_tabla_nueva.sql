DROP TABLE smn_rel_auxiliar_ceco_estorg;
DROP TABLE smn_impuest_deducc_detalle;
DROP TABLE smn_rel_requisicion_f_entrega;
DROP TABLE smn_requisicion_detalle;
DROP TABLE smn_requisicion_cabecera;
DROP TABLE smn_rel_ruta_aprobacion;
DROP TABLE smn_rel_proveedor_producto;
DROP TABLE smn_regla;
DROP TABLE smn_rel_usuarios_linea;
DROP TABLE smn_ruta;
DROP TABLE smn_roles;
DROP TABLE smn_rel_linea_afijo;
DROP TABLE smn_rel_linea_servicio;
DROP TABLE smn_servicio;
DROP TABLE smn_rel_linea_item;
DROP TABLE smn_proveedor;
DROP TABLE smn_motivo;
DROP TABLE smn_lineas;
DROP TABLE smn_tipo_linea;
DROP TABLE smn_documentos;
DROP TABLE smn_tipo_documento;
...
CREATE TABLE smn_rel_auxiliar_ceco_estorg(
  smn_rel_auxiliar_ceco_estorg_id SERIAL,
  ...
  rac_usuario CHARACTER(10) NOT NULL,
