...
if ('${fld:ocd_precio_ml}' == '') {
	document.getElementById("ocd_precio_ml").value=0;
}else{
	document.form1.ocd_precio_ml.value='${fld:ocd_precio_ml@#,###,##0.00}';
}

if ('${fld:ocd_precio_ma}' == '') {
	document.getElementById("ocd_precio_ma").value=0;
	
}else{
	document.form1.ocd_precio_ma.value='${fld:ocd_precio_ma@#,###,##0.00}';
