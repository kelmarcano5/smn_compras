...
VALUES
(
	nextval('smn_inventario.seq_smn_movimiento_detalle_desc_ret'), --smn_descuento_retencion_id
	${fld:smn_movimiento_detalle_id}, --smn_movimiento_detalle_id
	${fld:smn_codigo_descuento_rf}, --smn_codigo_descuento_rf
	${fld:mdd_monto_base_ml}, --mdd_monto_base_ml
	${fld:smn_porcentaje_rf}, --smn_porcentaje_rf
	${fld:mdd_monto_descuento_ml}, --mdd_monto_descuento_ml
...
RETURNING smn_descuento_retencion_id;