...
where
	smn_orden_compra_fecha_entrega_id is not null
	and smn_compras.smn_orden_compra_fecha_entrega.smn_orden_compra_detalle_id=${fld:id2}
	${filter} 
order by
		smn_compras.smn_orden_compra_fecha_entrega.smn_orden_compra_fecha_entrega_id desc
