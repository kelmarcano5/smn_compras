...
document.form1.oci_monto_base_ml.value='${fld:oci_monto_base_ml@#,###,##0.00}';
document.form1.oci_porcentaje_impuesto.value='${fld:oci_porcentaje_impuesto@#,###,###}';
document.form1.oci_sustraendo_ml.value='${fld:oci_sustraendo_ml@#,###,##0.00}';
setComboValue('smn_tipo_impuesto_rf','${fld:smn_tipo_impuesto_rf}','form1');
document.form1.oci_monto_impuesto_ml.value='${fld:oci_monto_impuesto_ml@#,###,##0.00}';
setComboValue('smn_moneda','${fld:smn_moneda}','form1');
setComboValue('smn_tasa','${fld:smn_tasa}','form1');
document.form1.oci_monto_impuesto_ma.value='${fld:oci_monto_impuesto_ma@#,###,##0.00}';
