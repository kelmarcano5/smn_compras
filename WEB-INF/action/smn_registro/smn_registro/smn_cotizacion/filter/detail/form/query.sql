...
from
	...
	left join smn_seguridad.s_user on smn_seguridad.s_user.userlogin = smn_compras.smn_requisicion_cabecera.req_usuario
	left join smn_base.smn_usuarios on smn_base.smn_usuarios.smn_user_rf = smn_seguridad.s_user.user_id
	left join smn_compras.smn_roles on smn_compras.smn_roles.smn_usuarios_id = smn_base.smn_usuarios.smn_usuarios_id
