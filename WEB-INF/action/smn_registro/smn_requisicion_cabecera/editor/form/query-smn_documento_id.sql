select 
	distinct smn_compras.smn_documentos.smn_documentos_id as id, 
	smn_compras.smn_documentos.dcc_modalidad as modalidad, 
	smn_compras.smn_documentos.dcc_codigo|| ' - ' || smn_compras.smn_documentos.dcc_nombre || ' - ' || smn_compras.smn_documentos.dcc_modalidad as item 
