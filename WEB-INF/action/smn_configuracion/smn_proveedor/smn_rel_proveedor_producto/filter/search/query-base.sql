...
from
	...
	inner join smn_compras.smn_rel_proveedor_producto on smn_compras.smn_rel_proveedor_producto.smn_proveedor_rf = smn_compras.smn_proveedor.smn_proveedor_id
	left outer join smn_base.smn_item it on it.smn_item_id = smn_compras.smn_rel_proveedor_producto.rpp_id_producto 
	...
	left outer join smn_compras.smn_servicio on smn_compras.smn_servicio.smn_servicio_id = smn_compras.smn_rel_proveedor_producto.smn_servicio_id
	
where
	smn_rel_proveedor_producto_id is not null
	and 	smn_compras.smn_proveedor.smn_proveedor_id=smn_compras.smn_rel_proveedor_producto.smn_proveedor_rf
	${filter}
order by
