...
from
	...
	inner join smn_base.smn_item it on it.smn_item_id = smn_compras.smn_rel_proveedor_producto.rpp_id_producto 
	inner join smn_base.smn_item it2 on it2.smn_item_id = smn_compras.smn_rel_proveedor_producto.rpp_producto_alterno
