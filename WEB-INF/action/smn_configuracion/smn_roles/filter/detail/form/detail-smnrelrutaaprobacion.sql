select
	...
	smn_compras.smn_regla.rul_nombre as rul_nombre_pl2,
	case
...
from
	...
	smn_compras.smn_rel_ruta_aprobacion
where
		smn_compras.smn_rel_ruta_aprobacion.smn_roles_id=smn_compras.smn_roles.smn_roles_id and
		smn_compras.smn_roles.smn_roles_id=${fld:id}  and
