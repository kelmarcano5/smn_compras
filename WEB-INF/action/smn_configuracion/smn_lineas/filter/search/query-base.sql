select	
	...
	smn_compras.smn_lineas.lin_codigo as lin_codigo, smn_compras.smn_lineas.lin_nombre as lin_nombre, smn_compras.smn_lineas.lin_fecha_registro
from
	smn_compras.smn_tipo_linea,
	smn_compras.smn_lineas 
where
	smn_lineas_id is not null
	and 	smn_compras.smn_tipo_linea.smn_tipo_linea_id=smn_compras.smn_lineas.smn_tipo_linea_id
	${filter}
order by
		smn_lineas_id
