select
	...
	smn_compras.smn_rel_ruta_aprobacion.rra_fecha_registro, smn_compras.smn_rel_ruta_aprobacion.smn_ruta_aprobacion_id
from
...
where
		smn_compras.smn_rel_ruta_aprobacion.smn_ruta_id=smn_compras.smn_ruta.smn_ruta_id and
		smn_compras.smn_ruta.smn_ruta_id=${fld:id}  and
