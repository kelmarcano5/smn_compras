select
	...
	smn_compras.smn_tipo_documento.tdc_codigo|| ' - ' ||smn_compras.smn_tipo_documento.tdc_nombre as smn_tipo_documento_id,smn_compras.smn_tipo_documento.tdc_nombre as tdc_nombre_pl0,
