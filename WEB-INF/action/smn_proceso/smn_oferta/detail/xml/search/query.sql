select
	...
	smn_base.smn_activo_fijo.acf_codigo ||' - '|| smn_base.smn_activo_fijo.acf_nombre as smn_activo_fijo_compras_id,
	...
	smn_base.smn_monedas.mon_codigo ||'-'|| smn_base.smn_monedas.mon_nombre as ofe_moneda_id,
	...
	smn_base.smn_tasas_de_cambio.smn_tasas_de_cambio_id as ofe_tasa,
	case 
	...
	inner join smn_compras.smn_proveedor on smn_compras.smn_proveedor.smn_proveedor_id = smn_compras.smn_cotizacion.smn_proveedor_id
	...
	INNER JOIN smn_base.smn_activo_fijo on smn_base.smn_activo_fijo.smn_afijo_id = smn_compras.smn_oferta.smn_activo_fijo_compras_id
	INNER JOIN smn_base.smn_servicios on smn_base.smn_servicios.smn_servicios_id = smn_compras.smn_oferta.smn_servicios_compras_id
	INNER JOIN smn_base.smn_monedas on smn_base.smn_monedas.smn_monedas_id = smn_compras.smn_oferta.ofe_moneda_id
	INNER JOIN smn_base.smn_tasas_de_cambio on smn_base.smn_tasas_de_cambio.smn_tasas_de_cambio_id = smn_compras.smn_oferta.ofe_tasa
