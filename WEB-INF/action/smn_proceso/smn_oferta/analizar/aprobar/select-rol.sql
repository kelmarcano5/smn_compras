...
AND
<<<<<<<< HEAD:WEB-INF/action/smn_proceso/smn_requisicion_cabecera1/aprobar/select-tipo_rol.sql
	smn_compras.smn_roles.rol_tipo = 'AP'
========
	smn_compras.smn_roles.rol_tipo = 'CO'
>>>>>>>> a57efee07d661d845df2ffc06524651f62dfc69e:WEB-INF/action/smn_proceso/smn_oferta/analizar/aprobar/select-rol.sql
