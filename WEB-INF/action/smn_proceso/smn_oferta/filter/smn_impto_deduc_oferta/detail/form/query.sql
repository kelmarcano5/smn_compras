select
	...
	INNER JOIN smn_base.smn_descuento on smn_base.smn_descuento.smn_descuento_id = smn_compras.smn_impto_deduc_oferta.rio_cod_descuento
...
where
	...
	smn_compras.smn_impto_deduc_oferta.smn_impuest_deducc_oferta_id = ${fld:id}
