...
select
		smn_compras.smn_impto_deduc_oferta.smn_impto_deduc_oferta_id,
	smn_compras.smn_impto_deduc_oferta.smn_oferta_id,
	smn_compras.smn_impto_deduc_oferta.rio_monto_base_ml,
	smn_compras.smn_impto_deduc_oferta.rio_cod_impuesto_deduc_id,
	smn_compras.smn_impto_deduc_oferta.rio_monto_impuesto_ml,
	smn_compras.smn_impto_deduc_oferta.rio_cod_descuento,
	smn_compras.smn_impto_deduc_oferta.rio_monto_base_ml,
...
where
	...
	smn_base.smn_tasas_de_cambio.smn_tasas_de_cambio_id = smn_compras.smn_impto_deduc_oferta.rio_tasa_rf
