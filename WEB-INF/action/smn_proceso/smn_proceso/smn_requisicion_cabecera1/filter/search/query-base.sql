...
CASE
		...
		'${lbl:b_versioned}' 
		WHEN smn_compras.smn_requisicion_cabecera.req_estatus = 'RZ' THEN
		'${lbl:b_rejected}' 
	END AS req_estatus,
...
FROM
	...
	INNER JOIN smn_base.smn_estructura_organizacional ON smn_base.smn_estructura_organizacional.smn_estructura_organizacional_id = smn_compras.smn_rel_auxiliar_ceco_estorg.smn_estructura_organizacional_rf 
WHERE
	smn_base.smn_estructura_organizacional.eor_aprobador = (SELECT  
