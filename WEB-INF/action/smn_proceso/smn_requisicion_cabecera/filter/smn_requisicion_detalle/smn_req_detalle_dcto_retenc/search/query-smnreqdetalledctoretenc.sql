select
	...
	smn_base.smn_descuentos_retenciones.dyr_porcentaje_descuento as drc_porcentaje,
...
where
	smn_compras.smn_req_detalle_dcto_retenc.smn_requisicion_detalle_id=${fld:id5}
